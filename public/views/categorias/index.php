    ...
    <div class="form-comp">
        <div>
            <div class="form-outline">
                ...
                <label class="form-label" for="form6Example1">Nueva Categoría</label>
            </div>
        </div>
        <div>
            <button class="btn btn-floating bg-base-color agregar" title="Agregar Categoría"><i class="fa-solid fa-plus"></i></button>
        </div>
    </div>
    <div id="textExample1" class="form-text text-danger categoria-unique"></div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <div class="form-outline mb-2">
                    <input type="text" id="form6Example2" class="form-control" name="ecategoria" maxlength="25" onkeyup="validare(this);Mayus(this)" onkeypress="return soloLetras(event)" onkeyup=""/>
...
<script src="<?=url_global?>/public/recursos/js/categoria.js"></script>
