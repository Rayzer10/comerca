<?php
    ...
    class MarcaModel extends Conection{
        ...
        public function agregar($datos){
            try{
                $sql = $this->insert($datos, "marca");
                $arraySinClaves = array_values($datos);
                $stmt = $this->db->prepare($sql);
                $stmt->execute($arraySinClaves);
                $this->historial("agregó nuevo marca");
            } catch(PDOException $e){
        ...
        public function actualizar($data, $id){
            try{
                ...
                $this->historial("actualizó una marca");
            } catch(PDOException $e){
        ...
        public function eliminar($id){
            try{
                ...
                $stmt = $this->db->prepare($sql);
                $stmt->execute([$id]);
                $this->historial("Eliminó una marca");
            }catch(PDOexception $e){
